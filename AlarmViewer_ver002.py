...
# -*- coding: utf-8 -*-
"""
Created on Sat Nov 18 22:06:41 2017

@author: Nikolaus Rieder
Derived from Alarmviewer ver001
Changes in ver002
tkinter Event handling (Confirm input with Enter, etc)
...
if __name__ == '__main__':
    ...
    run = start()
    run.after(4000, lambda: run.updateList(statusDictionary))
    run.mainloop()